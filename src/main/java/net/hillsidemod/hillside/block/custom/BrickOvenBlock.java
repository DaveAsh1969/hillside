...
public class BrickOvenBlock extends BlockWithEntity implements BlockEntityProvider {
    ...
    public ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, Hand hand, BlockHitResult hit) {
        if(!world.isClient) {
            ...
            NamedScreenHandlerFactory screenHandlerFactory = ((BrickOvenBlockEntity) world.getBlockEntity(pos));
    ...
    public <T extends BlockEntity> BlockEntityTicker<T> getTicker(World world, BlockState state, BlockEntityType<T> type) {
        ...
        return checkType(type, ModBlockEntities.BRICK_OVEN, (world1, pos, state1, blockEntity) -> blockEntity.tick(world1, pos, state1));
    }
